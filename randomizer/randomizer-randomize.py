...
items_nontm = [
		...
		items['ITEM_ALORAICHIUM_Z'],
		items['ITEM_DECIDIUM_Z'],
		items['ITEM_EEVIUM_Z'],
		items['ITEM_INCINIUM_Z'],
		items['ITEM_KOMMONIUM_Z'],
		items['ITEM_LUNALIUM_Z'],
		items['ITEM_LYCANIUM_Z'],
		items['ITEM_MARSHADIUM_Z'],
		items['ITEM_MEWNIUM_Z'],
		items['ITEM_MIMIKIUM_Z'],
		items['ITEM_PIKANIUM_Z'],
		items['ITEM_PIKASHUNIUM_Z'],
		items['ITEM_PRIMARIUM_Z'],
		items['ITEM_SNORLIUM_Z'],
		items['ITEM_SOLGANIUM_Z'],
		items['ITEM_TAPUNIUM_Z'],
		items['ITEM_ULTRANECROZIUM_Z']
		]
