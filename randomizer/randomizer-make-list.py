...
item_labels['gNewGamePCItems'] = ('pc',items['ITEM_POTION'],'any',None)

item_labels['RustboroCity_DevonCorp_3F_EventScript_GiveExpShare'] = ('giveitem',items['ITEM_MASTER_BALL'],'any',None)
item_labels['PlayersHouse_1F_EventScript_TryGiveAmuletCoin'] = ('giveitem',items['ITEM_AMULET_COIN'],'any',None)
item_labels['OldaleTown_EventScript_ExplainPokemonMart'] = ('giveitem',items['ITEM_POTION'],'any',None)
item_labels['Route104_EventScript_Boy2'] = ('giveitem',items['ITEM_TM09'],'tm',None)
item_labels['Route104_EventScript_WhiteHerbFlorist'] = ('giveitem',items['ITEM_WHITE_HERB'],'any',None)
item_labels['Route104_EventScript_ExpertF'] = ('giveitem',items['ITEM_CHESTO_BERRY'],'berry',None)
item_labels['PetalburgWoods_EventScript_DevonResearcherPostBattle'] = ('giveitem',items['ITEM_GREAT_BALL'],'any',None)
item_labels['PetalburgWoods_EventScript_Girl'] = ('giveitem',items['ITEM_MIRACLE_SEED'],'any',None)
item_labels['RustboroCity_Flat2_2F_EventScript_NinjaBoy'] = ('giveitem',items['ITEM_PREMIER_BALL'],'any',None)
item_labels['RustboroCity_EventScript_ReturnGoods'] = ('giveitem',items['ITEM_GREAT_BALL'],'any',None)
item_labels['Route114_FossilManiacsHouse_EventScript_FossilManiacsBrother'] = ('giveitem',items['ITEM_TM28'],'tm',None)
item_labels['Route114_EventScript_RoarGentleman'] = ('giveitem',items['ITEM_TM05'],'tm',None)
item_labels['FallarborTown_CozmosHouse_EventScript_PlayerHasMeteorite'] = ('giveitem',items['ITEM_TM27'],'tm',None)
item_labels['Route111_WinstrateFamilysHouse_EventScript_Victoria'] = ('giveitem',items['ITEM_MACHO_BRACE'],'any',None)
item_labels['LavaridgeTown_HerbShop_EventScript_OldMan'] = ('giveitem',items['ITEM_CHARCOAL'],'any',None)
item_labels['VerdanturfTown_BattleTentLobby_EventScript_AttractGiver'] = ('giveitem',items['ITEM_TM45'],'tm',None)
item_labels['Route116_EventScript_GiveRepeatBall'] = ('giveitem',items['ITEM_REPEAT_BALL'],'any',None)
item_labels['GraniteCave_StevensRoom_EventScript_Steven'] = ('giveitem',items['ITEM_TM47'],'tm',None)
item_labels['DewfordTown_Hall_EventScript_SludgeBombMan'] = ('giveitem',items['ITEM_TM36'],'tm',None)
item_labels['DewfordTown_House2_EventScript_Man'] = ('giveitem',items['ITEM_SILK_SCARF'],'any',None)
item_labels['Route109_EventScript_SoftSandGirl'] = ('giveitem',items['ITEM_SOFT_SAND'],'any',None)
item_labels['Route109_SeashoreHouse_EventScript_DefeatedTrainers'] = ('giveitem',items['ITEM_SODA_POP'],'any',None)
item_labels['SlateportCity_BattleTentLobby_EventScript_TormentGiver'] = ('giveitem',items['ITEM_TM41'],'tm',None)
item_labels['SlateportCity_OceanicMuseum_1F_EventScript_FamiliarGrunt'] = ('giveitem',items['ITEM_TM46'],'tm',None)
item_labels['PacifidlogTown_House2_EventScript_GiveReturn'] = ('giveitem',items['ITEM_TM27'],'tm',None)
item_labels['PacifidlogTown_House2_EventScript_GiveFrustration'] = ('giveitem',items['ITEM_TM21'],'tm',None)
item_labels['MossdeepCity_EventScript_KingsRockBoy'] = ('giveitem',items['ITEM_KINGS_ROCK'],'any',None)
item_labels['ShoalCave_LowTideLowerRoom_EventScript_BlackBelt'] = ('giveitem',items['ITEM_FOCUS_BAND'],'any',None)
item_labels['SootopolisCity_House1_EventScript_BrickBreakBlackBelt'] = ('giveitem',items['ITEM_TM31'],'tm',None)
item_labels['LilycoveCity_House2_EventScript_FatMan'] = ('giveitem',items['ITEM_TM44'],'tm',None)
item_labels['Route123_EventScript_GigaDrainGirl'] = ('giveitem',items['ITEM_TM19'],'tm',None)
item_labels['FortreeCity_House2_EventScript_HiddenPowerGiver'] = ('giveitem',items['ITEM_TM10'],'tm',None)
item_labels['FortreeCity_House4_EventScript_WingullReturned'] = ('giveitem',items['ITEM_MENTAL_HERB'],'any',None)
item_labels['MtPyre_1F_EventScript_CleanseTagWoman'] = ('giveitem',items['ITEM_CLEANSE_TAG'],'any',None)

item_id = encounter_id

# Gym Badge TMs:
## Rock Tomb TM39 0x0802
item_labels['RustboroCity_Gym_EventScript_GiveRockTomb'] = ('giveitem',items['ITEM_TM39'],'tm',item_id)
item_id+=1
## Bulk Up TM08 0xe901
item_labels['DewfordTown_Gym_EventScript_GiveBulkUp'] = ('giveitem',items['ITEM_TM08'],'tm',item_id)
item_labels['DewfordTown_Gym_EventScript_GiveBulkUp2'] = ('giveitem',items['ITEM_TM08'],'tm',item_id)
item_id+=1
## Shockwave TM34 0x0302
item_labels['MauvilleCity_Gym_EventScript_GiveShockWave'] = ('giveitem',items['ITEM_TM34'],'tm',item_id)
item_labels['MauvilleCity_Gym_EventScript_GiveShockWave2'] = ('giveitem',items['ITEM_TM34'],'tm',item_id)
item_id+=1
## Overheat TM50 0x1302
item_labels['LavaridgeTown_Gym_1F_EventScript_GiveOverheat'] = ('giveitem',items['ITEM_TM50'],'tm',item_id)
item_labels['LavaridgeTown_Gym_1F_EventScript_GiveOverheat2'] = ('giveitem',items['ITEM_TM50'],'tm',item_id)
item_id+=1
## Facade TM42 0x0b02
item_labels['PetalburgCity_Gym_EventScript_GiveFacade'] = ('giveitem',items['ITEM_TM42'],'tm',item_id)
item_id+=1
## Aerial Ace TM40 0x0902
item_labels['FortreeCity_Gym_EventScript_GiveAerialAce'] = ('giveitem',items['ITEM_TM40'],'tm',item_id)
item_labels['FortreeCity_Gym_EventScript_GiveAerialAce2'] = ('giveitem',items['ITEM_TM40'],'tm',item_id)
item_id+=1
## Calm Mind TM04 0xeitem_id
item_labels['MossdeepCity_Gym_EventScript_GiveCalmMind'] = ('giveitem',items['ITEM_TM04'],'tm',item_id)
item_labels['MossdeepCity_Gym_EventScript_GiveCalmMind2'] = ('giveitem',items['ITEM_TM04'],'tm',item_id)
item_id+=1
## Water Pulse TM03 0xe401
item_labels['SootopolisCity_Gym_1F_EventScript_GiveWaterPulse'] = ('giveitem',items['ITEM_TM03'],'tm',item_id)
item_labels['SootopolisCity_Gym_1F_EventScript_GiveWaterPulse2'] = ('giveitem',items['ITEM_TM03'],'tm',item_id)
item_id+=1

# Scattered Items:

item_labels['Route102_EventScript_ItemPotion'] = ('finditem',items['ITEM_POTION'],'any',None)
item_labels['Route103_EventScript_ItemGuardSpec'] = ('finditem',items['ITEM_GUARD_SPEC'],'any',None)
item_labels['Route103_EventScript_ItemPPUp'] = ('finditem',items['ITEM_PP_UP'],'any',None)
item_labels['Route104_EventScript_ItemPPUp'] = ('finditem',items['ITEM_PP_UP'],'any',None)
item_labels['Route104_EventScript_ItemPokeBall'] = ('finditem',items['ITEM_POKE_BALL'],'any',None)
item_labels['Route104_EventScript_ItemXAccuracy'] = ('finditem',items['ITEM_X_ACCURACY'],'any',None)
item_labels['Route104_EventScript_ItemPotion'] = ('finditem',items['ITEM_POTION'],'any',None)
item_labels['Route105_EventScript_ItemIron'] = ('finditem',items['ITEM_IRON'],'any',None)
item_labels['Route106_EventScript_ItemProtein'] = ('finditem',items['ITEM_PROTEIN'],'any',None)
item_labels['Route108_EventScript_ItemStarPiece'] = ('finditem',items['ITEM_STAR_PIECE'],'any',None)
item_labels['Route109_EventScript_ItemPPUp'] = ('finditem',items['ITEM_PP_UP'],'any',None)
item_labels['Route109_EventScript_ItemPotion'] = ('finditem',items['ITEM_POTION'],'any',None)
item_labels['Route110_EventScript_ItemRareCandy'] = ('finditem',items['ITEM_RARE_CANDY'],'any',None)
item_labels['Route110_EventScript_ItemDireHit'] = ('finditem',items['ITEM_DIRE_HIT'],'any',None)
item_labels['Route110_EventScript_ItemElixir'] = ('finditem',items['ITEM_ELIXIR'],'any',None)
item_labels['Route111_EventScript_ItemTM37'] = ('finditem',items['ITEM_TM37'],'tm',None)
item_labels['Route111_EventScript_ItemStardust'] = ('finditem',items['ITEM_STARDUST'],'any',None)
item_labels['Route111_EventScript_ItemHPUp'] = ('finditem',items['ITEM_HP_UP'],'any',None)
item_labels['Route111_EventScript_ItemElixir'] = ('finditem',items['ITEM_ELIXIR'],'any',None)
item_labels['Route112_EventScript_ItemNugget'] = ('finditem',items['ITEM_NUGGET'],'any',None)
item_labels['Route113_EventScript_ItemMaxEther'] = ('finditem',items['ITEM_MAX_ETHER'],'any',None)
item_labels['Route113_EventScript_ItemSuperRepel'] = ('finditem',items['ITEM_SUPER_REPEL'],'any',None)
item_labels['Route113_EventScript_ItemHyperPotion'] = ('finditem',items['ITEM_SUPER_POTION'],'any',None)
item_labels['Route114_EventScript_ItemRareCandy'] = ('finditem',items['ITEM_RARE_CANDY'],'any',None)
item_labels['Route114_EventScript_ItemProtein'] = ('finditem',items['ITEM_PROTEIN'],'any',None)
item_labels['Route114_EventScript_ItemEnergyPowder'] = ('finditem',items['ITEM_ENERGY_POWDER'],'any',None)
item_labels['Route115_EventScript_ItemSuperPotion'] = ('finditem',items['ITEM_SUPER_POTION'],'any',None)
item_labels['Route115_EventScript_ItemTM01'] = ('finditem',items['ITEM_TM01'],'tm',None)
item_labels['Route115_EventScript_ItemIron'] = ('finditem',items['ITEM_IRON'],'any',None)
item_labels['Route115_EventScript_ItemGreatBall'] = ('finditem',items['ITEM_GREAT_BALL'],'any',None)
item_labels['Route115_EventScript_ItemHealPowder'] = ('finditem',items['ITEM_HEAL_POWDER'],'any',None)
item_labels['Route115_EventScript_ItemPPUp'] = ('finditem',items['ITEM_PP_UP'],'any',None)
item_labels['Route116_EventScript_ItemXSpecial'] = ('finditem',items['ITEM_X_SP_ATK'],'any',None)
item_labels['Route116_EventScript_ItemEther'] = ('finditem',items['ITEM_ETHER'],'any',None)
item_labels['Route116_EventScript_ItemRepel'] = ('finditem',items['ITEM_REPEL'],'any',None)
item_labels['Route116_EventScript_ItemHPUp'] = ('finditem',items['ITEM_HP_UP'],'any',None)
item_labels['Route116_EventScript_ItemPotion'] = ('finditem',items['ITEM_POTION'],'any',None)
item_labels['Route117_EventScript_ItemGreatBall'] = ('finditem',items['ITEM_GREAT_BALL'],'any',None)
item_labels['Route117_EventScript_ItemRevive'] = ('finditem',items['ITEM_REVIVE'],'any',None)
item_labels['Route118_EventScript_ItemHyperPotion'] = ('finditem',items['ITEM_HYPER_POTION'],'any',None)
item_labels['Route119_EventScript_ItemSuperRepel'] = ('finditem',items['ITEM_SUPER_REPEL'],'any',None)
item_labels['Route119_EventScript_ItemZinc'] = ('finditem',items['ITEM_ZINC'],'any',None)
item_labels['Route119_EventScript_ItemElixir'] = ('finditem',items['ITEM_ELIXIR'],'any',None)
item_labels['Route119_EventScript_ItemLeafStone'] = ('finditem',items['ITEM_LEAF_STONE'],'any',None)
item_labels['Route119_EventScript_ItemRareCandy'] = ('finditem',items['ITEM_RARE_CANDY'],'any',None)
item_labels['Route119_EventScript_ItemHyperPotion'] = ('finditem',items['ITEM_HYPER_POTION'],'any',None)
item_labels['Route119_EventScript_ItemHyperPotion2'] = ('finditem',items['ITEM_HYPER_POTION'],'any',None)
item_labels['Route119_EventScript_ItemElixir2'] = ('finditem',items['ITEM_ELIXIR'],'any',None)
item_labels['Route120_EventScript_ItemNugget'] = ('finditem',items['ITEM_NUGGET'],'any',None)
item_labels['Route120_EventScript_ItemFullHeal'] = ('finditem',items['ITEM_FULL_HEAL'],'any',None)
item_labels['Route120_EventScript_ItemHyperPotion'] = ('finditem',items['ITEM_HYPER_POTION'],'any',None)
item_labels['Route120_EventScript_ItemNestBall'] = ('finditem',items['ITEM_NEST_BALL'],'any',None)
item_labels['Route120_EventScript_ItemRevive'] = ('finditem',items['ITEM_REVIVE'],'any',None)
item_labels['Route121_EventScript_ItemCarbos'] = ('finditem',items['ITEM_CARBOS'],'any',None)
item_labels['Route121_EventScript_ItemRevive'] = ('finditem',items['ITEM_REVIVE'],'any',None)
item_labels['Route121_EventScript_ItemZinc'] = ('finditem',items['ITEM_ZINC'],'any',None)
item_labels['Route123_EventScript_ItemCalcium'] = ('finditem',items['ITEM_CALCIUM'],'any',None)
item_labels['Route123_EventScript_ItemUltraBall'] = ('finditem',items['ITEM_ULTRA_BALL'],'any',None)
item_labels['Route123_EventScript_ItemElixir'] = ('finditem',items['ITEM_ELIXIR'],'any',None)
item_labels['Route123_EventScript_ItemPPUp'] = ('finditem',items['ITEM_PP_UP'],'any',None)
item_labels['Route123_EventScript_ItemRevivalHerb'] = ('finditem',items['ITEM_REVIVAL_HERB'],'any',None)
item_labels['Route124_EventScript_ItemRedShard'] = ('finditem',items['ITEM_RED_SHARD'],'any',None)
item_labels['Route124_EventScript_ItemBlueShard'] = ('finditem',items['ITEM_BLUE_SHARD'],'any',None)
item_labels['Route124_EventScript_ItemYellowShard'] = ('finditem',items['ITEM_YELLOW_SHARD'],'any',None)
item_labels['Route125_EventScript_ItemBigPearl'] = ('finditem',items['ITEM_BIG_PEARL'],'any',None)
item_labels['Route126_EventScript_ItemGreenShard'] = ('finditem',items['ITEM_GREEN_SHARD'],'any',None)
item_labels['Route127_EventScript_ItemZinc'] = ('finditem',items['ITEM_ZINC'],'any',None)
item_labels['Route127_EventScript_ItemCarbos'] = ('finditem',items['ITEM_CARBOS'],'any',None)
item_labels['Route127_EventScript_ItemRareCandy'] = ('finditem',items['ITEM_RARE_CANDY'],'any',None)
item_labels['Route132_EventScript_ItemRareCandy'] = ('finditem',items['ITEM_RARE_CANDY'],'any',None)
item_labels['Route132_EventScript_ItemProtein'] = ('finditem',items['ITEM_PROTEIN'],'any',None)
item_labels['Route133_EventScript_ItemBigPearl'] = ('finditem',items['ITEM_BIG_PEARL'],'any',None)
item_labels['Route133_EventScript_ItemStarPiece'] = ('finditem',items['ITEM_STAR_PIECE'],'any',None)
item_labels['Route133_EventScript_ItemMaxRevive'] = ('finditem',items['ITEM_MAX_REVIVE'],'any',None)
item_labels['Route134_EventScript_ItemCarbos'] = ('finditem',items['ITEM_CARBOS'],'any',None)
item_labels['Route134_EventScript_ItemStarPiece'] = ('finditem',items['ITEM_STAR_PIECE'],'any',None)
item_labels['PetalburgCity_EventScript_ItemMaxRevive'] = ('finditem',items['ITEM_MAX_REVIVE'],'any',None)
item_labels['PetalburgCity_EventScript_ItemEther'] = ('finditem',items['ITEM_ETHER'],'any',None)
item_labels['MauvilleCity_EventScript_ItemXSpeed'] = ('finditem',items['ITEM_X_SPEED'],'any',None)
item_labels['RustboroCity_EventScript_ItemXDefend'] = ('finditem',items['ITEM_X_DEFENSE'],'any',None)
item_labels['LilycoveCity_EventScript_ItemMaxRepel'] = ('finditem',items['ITEM_MAX_REPEL'],'any',None)
item_labels['MossdeepCity_EventScript_ItemNetBall'] = ('finditem',items['ITEM_NET_BALL'],'any',None)
item_labels['PetalburgWoods_EventScript_ItemXAttack'] = ('finditem',items['ITEM_X_ATTACK'],'any',None)
item_labels['PetalburgWoods_EventScript_ItemGreatBall'] = ('finditem',items['ITEM_GREAT_BALL'],'any',None)
item_labels['PetalburgWoods_EventScript_ItemEther'] = ('finditem',items['ITEM_ETHER'],'any',None)
item_labels['PetalburgWoods_EventScript_ItemParalyzeHeal'] = ('finditem',items['ITEM_PARALYZE_HEAL'],'any',None)
item_labels['RusturfTunnel_EventScript_ItemPokeBall'] = ('finditem',items['ITEM_POKE_BALL'],'any',None)
item_labels['RusturfTunnel_EventScript_ItemMaxEther'] = ('finditem',items['ITEM_MAX_ETHER'],'any',None)
item_labels['GraniteCave_1F_EventScript_ItemEscapeRope'] = ('finditem',items['ITEM_ESCAPE_ROPE'],'any',None)
item_labels['GraniteCave_B1F_EventScript_ItemPokeBall'] = ('finditem',items['ITEM_POKE_BALL'],'any',None)
item_labels['GraniteCave_B2F_EventScript_ItemRepel'] = ('finditem',items['ITEM_REPEL'],'any',None)
item_labels['GraniteCave_B2F_EventScript_ItemRareCandy'] = ('finditem',items['ITEM_RARE_CANDY'],'any',None)
item_labels['JaggedPass_EventScript_ItemBurnHeal'] = ('finditem',items['ITEM_BURN_HEAL'],'any',None)
item_labels['FieryPath_EventScript_ItemFireStone'] = ('finditem',items['ITEM_FIRE_STONE'],'any',None)
item_labels['FieryPath_EventScript_ItemTM06'] = ('finditem',items['ITEM_TM06'],'tm',None)
item_labels['MeteorFalls_1F_1R_EventScript_ItemTM23'] = ('finditem',items['ITEM_TM23'],'tm',None)
item_labels['MeteorFalls_1F_1R_EventScript_ItemFullHeal'] = ('finditem',items['ITEM_FULL_HEAL'],'any',None)
item_labels['MeteorFalls_1F_1R_EventScript_ItemMoonStone'] = ('finditem',items['ITEM_MOON_STONE'],'any',None)
item_labels['MeteorFalls_1F_1R_EventScript_ItemPPUP'] = ('finditem',items['ITEM_PP_UP'],'any',None)
item_labels['MeteorFalls_B1F_2R_EventScript_ItemTM02'] = ('finditem',items['ITEM_TM02'],'tm',None)
item_labels['NewMauville_Inside_EventScript_ItemUltraBall'] = ('finditem',items['ITEM_ULTRA_BALL'],'any',None)
item_labels['NewMauville_Inside_EventScript_ItemEscapeRope'] = ('finditem',items['ITEM_ESCAPE_ROPE'],'any',None)
item_labels['NewMauville_Inside_EventScript_ItemThunderStone'] = ('finditem',items['ITEM_THUNDER_STONE'],'any',None)
item_labels['NewMauville_Inside_EventScript_ItemFullHeal'] = ('finditem',items['ITEM_FULL_HEAL'],'any',None)
item_labels['NewMauville_Inside_EventScript_ItemParalyzeHeal'] = ('finditem',items['ITEM_PARALYZE_HEAL'],'any',None)
item_labels['AbandonedShip_Rooms_1F_EventScript_ItemHarborMail'] = ('finditem',items['ITEM_HARBOR_MAIL'],'any',None)
item_labels['AbandonedShip_Rooms_B1F_EventScript_ItemEscapeRope'] = ('finditem',items['ITEM_ESCAPE_ROPE'],'any',None)
item_labels['AbandonedShip_Rooms2_B1F_EventScript_ItemDiveBall'] = ('finditem',items['ITEM_DIVE_BALL'],'any',None)
item_labels['AbandonedShip_Room_B1F_EventScript_ItemTM13'] = ('finditem',items['ITEM_TM13'],'tm',None)
item_labels['AbandonedShip_Rooms2_1F_EventScript_ItemRevive'] = ('finditem',items['ITEM_REVIVE'],'any',None)
item_labels['AbandonedShip_HiddenFloorRooms_EventScript_ItemLuxuryBall'] = ('finditem',items['ITEM_LUXURY_BALL'],'any',None)
item_labels['AbandonedShip_HiddenFloorRooms_EventScript_ItemWaterStone'] = ('finditem',items['ITEM_WATER_STONE'],'any',None)
item_labels['AbandonedShip_HiddenFloorRooms_EventScript_ItemTM18'] = ('finditem',items['ITEM_TM18'],'tm',None)
item_labels['ScorchedSlab_EventScript_ItemTM11'] = ('finditem',items['ITEM_TM11'],'tm',None)
item_labels['SafariZone_Northwest_EventScript_ItemTM22'] = ('finditem',items['ITEM_TM22'],'tm',None)
item_labels['SafariZone_North_EventScript_ItemCalcium'] = ('finditem',items['ITEM_CALCIUM'],'any',None)
item_labels['SafariZone_Southwest_EventScript_ItemMaxRevive'] = ('finditem',items['ITEM_MAX_REVIVE'],'any',None)
item_labels['SafariZone_Northeast_EventScript_ItemNugget'] = ('finditem',items['ITEM_NUGGET'],'any',None)
item_labels['SafariZone_Southeast_EventScript_ItemBigPearl'] = ('finditem',items['ITEM_BIG_PEARL'],'any',None)
item_labels['MtPyre_2F_EventScript_ItemUltraBall'] = ('finditem',items['ITEM_ULTRA_BALL'],'any',None)
item_labels['MtPyre_3F_EventScript_ItemSuperRepel'] = ('finditem',items['ITEM_SUPER_REPEL'],'any',None)
item_labels['MtPyre_4F_EventScript_ItemSeaIncense'] = ('finditem',items['ITEM_SEA_INCENSE'],'any',None)
item_labels['MtPyre_5F_EventScript_ItemLaxIncense'] = ('finditem',items['ITEM_LAX_INCENSE'],'any',None)
item_labels['MtPyre_6F_EventScript_ItemTM30'] = ('finditem',items['ITEM_TM30'],'tm',None)
item_labels['MtPyre_Exterior_EventScript_ItemMaxPotion'] = ('finditem',items['ITEM_MAX_POTION'],'any',None)
item_labels['MtPyre_Exterior_EventScript_ItemTM48'] = ('finditem',items['ITEM_TM48'],'tm',None)
item_labels['AquaHideout_B1F_EventScript_ItemMasterBall'] = ('finditem',items['ITEM_MASTER_BALL'],'any',None)
item_labels['AquaHideout_B1F_EventScript_ItemNugget'] = ('finditem',items['ITEM_NUGGET'],'any',None)
item_labels['AquaHideout_B1F_EventScript_ItemMaxElixir'] = ('finditem',items['ITEM_MAX_ELIXIR'],'any',None)
item_labels['AquaHideout_B2F_EventScript_ItemNestBall'] = ('finditem',items['ITEM_NEST_BALL'],'any',None)
item_labels['AquaHideout_B2F_EventScript_ItemMasterBall'] = ('finditem',items['ITEM_MASTER_BALL'],'any',None)
item_labels['Route119_EventScript_ItemNugget'] = ('finditem',items['ITEM_NUGGET'],'any',None)
item_labels['Route119_EventScript_ItemMaxElixir'] = ('finditem',items['ITEM_MAX_ELIXIR'],'any',None)
item_labels['Route119_EventScript_ItemNestBall'] = ('finditem',items['ITEM_NEST_BALL'],'any',None)
item_labels['ShoalCave_LowTideEntranceRoom_EventScript_ItemBigPearl'] = ('finditem',items['ITEM_BIG_PEARL'],'any',None)
item_labels['ShoalCave_LowTideInnerRoom_EventScript_ItemRareCandy'] = ('finditem',items['ITEM_RARE_CANDY'],'any',None)
item_labels['ShoalCave_LowTideStairsRoom_EventScript_ItemIceHeal'] = ('finditem',items['ITEM_ICE_HEAL'],'any',None)
item_labels['ShoalCave_LowTideIceRoom_EventScript_ItemTM07'] = ('finditem',items['ITEM_TM07'],'tm',None)
item_labels['ShoalCave_LowTideIceRoom_EventScript_ItemNeverMeltIce'] = ('finditem',items['ITEM_NEVER_MELT_ICE'],'any',None)
item_labels['SeafloorCavern_Room9_EventScript_ItemTM26'] = ('finditem',items['ITEM_TM26'],'tm',None)
item_labels['Route110_TrickHousePuzzle1_EventScript_ItemOrangeMail'] = ('finditem',items['ITEM_ORANGE_MAIL'],'any',None)
item_labels['Route110_TrickHousePuzzle2_EventScript_ItemHarborMail'] = ('finditem',items['ITEM_HARBOR_MAIL'],'any',None)
item_labels['Route110_TrickHousePuzzle2_EventScript_ItemWaveMail'] = ('finditem',items['ITEM_WAVE_MAIL'],'any',None)
item_labels['Route110_TrickHousePuzzle3_EventScript_ItemShadowMail'] = ('finditem',items['ITEM_SHADOW_MAIL'],'any',None)
item_labels['Route110_TrickHousePuzzle3_EventScript_ItemWoodMail'] = ('finditem',items['ITEM_WOOD_MAIL'],'any',None)
item_labels['Route110_TrickHousePuzzle4_EventScript_ItemMechMail'] = ('finditem',items['ITEM_MECH_MAIL'],'any',None)
item_labels['Route110_TrickHousePuzzle6_EventScript_ItemGlitterMail'] = ('finditem',items['ITEM_GLITTER_MAIL'],'any',None)
item_labels['Route110_TrickHousePuzzle7_EventScript_ItemTropicMail'] = ('finditem',items['ITEM_TROPIC_MAIL'],'any',None)
item_labels['Route110_TrickHousePuzzle8_EventScript_ItemBeadMail'] = ('finditem',items['ITEM_BEAD_MAIL'],'any',None)
item_labels['VictoryRoad_1F_EventScript_ItemMaxElixir'] = ('finditem',items['ITEM_MAX_ELIXIR'],'any',None)
item_labels['VictoryRoad_1F_EventScript_ItemPPUp'] = ('finditem',items['ITEM_PP_UP'],'any',None)
item_labels['VictoryRoad_B1F_EventScript_ItemTM29'] = ('finditem',items['ITEM_TM29'],'any',None)
item_labels['VictoryRoad_B1F_EventScript_ItemFullRestore'] = ('finditem',items['ITEM_FULL_RESTORE'],'any',None)
item_labels['VictoryRoad_B2F_EventScript_ItemFullHeal'] = ('finditem',items['ITEM_FULL_HEAL'],'any',None)
item_labels['ArtisanCave_B1F_EventScript_ItemHPUp'] = ('finditem',items['ITEM_HP_UP'],'any',None)
item_labels['ArtisanCave_1F_EventScript_ItemCarbos'] = ('finditem',items['ITEM_CARBOS'],'any',None)
item_labels['MagmaHideout_1F_EventScript_ItemRareCandy'] = ('finditem',items['ITEM_RARE_CANDY'],'any',None)
item_labels['MagmaHideout_2F_2R_EventScript_MaxElixir'] = ('finditem',items['ITEM_MAX_ELIXIR'],'any',None)
item_labels['MagmaHideout_2F_2R_EventScript_ItemFullRestore'] = ('finditem',items['ITEM_FULL_RESTORE'],'any',None)
item_labels['MagmaHideout_3F_1R_EventScript_ItemNugget'] = ('finditem',items['ITEM_NUGGET'],'any',None)
item_labels['MagmaHideout_3F_2R_EventScript_ItemPPMax'] = ('finditem',items['ITEM_PP_MAX'],'any',None)
item_labels['MagmaHideout_4F_EventScript_MaxRevive'] = ('finditem',items['ITEM_MAX_REVIVE'],'any',None)
item_labels['MagmaHideout_3F_3R_EventScript_ItemEscapeRope'] = ('finditem',items['ITEM_ESCAPE_ROPE'],'any',None)
...
hidden_item_labels['MtPyre_Summit_MapBGEvents'] = [
		('bg_hidden_item_event',items['ITEM_ZINC'], 'any'),
		('bg_hidden_item_event',items['ITEM_RARE_CANDY'], 'any'),
		]

hidden_item_labels['Route110_TrickHouseEnd_MapBGEvents'] = [
		('bg_hidden_item_event',items['ITEM_NUGGET'], 'any'),
		]

hidden_item_labels['Underwater_Route126_MapBGEvents'] = [
		('bg_hidden_item_event',items['ITEM_HEART_SCALE'], 'any'),
		('bg_hidden_item_event',items['ITEM_ULTRA_BALL'], 'any'),
		('bg_hidden_item_event',items['ITEM_STARDUST'], 'any'),
		('bg_hidden_item_event',items['ITEM_PEARL'], 'any'),
		('bg_hidden_item_event',items['ITEM_IRON'], 'any'),
		('bg_hidden_item_event',items['ITEM_YELLOW_SHARD'], 'any'),
		('bg_hidden_item_event',items['ITEM_BIG_PEARL'], 'any'),
		('bg_hidden_item_event',items['ITEM_BLUE_SHARD'], 'any'),
		]

hidden_item_labels['Underwater_Route127_MapBGEvents'] = [
		('bg_hidden_item_event',items['ITEM_STAR_PIECE'], 'any'),
		('bg_hidden_item_event',items['ITEM_HP_UP'], 'any'),
		('bg_hidden_item_event',items['ITEM_HEART_SCALE'], 'any'),
		('bg_hidden_item_event',items['ITEM_RED_SHARD'], 'any'),
		]
...
hidden_item_labels['Route117_MapBGEvents'] = [
		...
		('ignore',None, 'any'),
		('ignore',None, 'any'),
		('bg_hidden_item_event',items['ITEM_REPEL'], 'any'),
		]
...
hidden_item_labels['Route109_MapBGEvents'] = [
		('ignore',None, 'any'),
		('ignore',None, 'any'),
		('bg_hidden_item_event',items['ITEM_REVIVE'], 'any'),
		('bg_hidden_item_event',items['ITEM_HEART_SCALE'], 'any'),
		('bg_hidden_item_event',items['ITEM_GREAT_BALL'], 'any'),
		('bg_hidden_item_event',items['ITEM_ETHER'], 'any'),
		('bg_hidden_item_event',items['ITEM_HEART_SCALE'], 'any'),
		('bg_hidden_item_event',items['ITEM_HEART_SCALE'], 'any'),
		]
...
hidden_item_labels['LavaridgeTown_MapBGEvents'] = [
		...
		('ignore',None, 'any'),
		('ignore',None, 'any'),
		('bg_hidden_item_event',items['ITEM_ICE_HEAL'], 'any'),
		]
...
hidden_item_labels['Route111_MapBGEvents'] = [
		...
		('ignore',None, 'any'),
		('ignore',None, 'any'),
		('bg_hidden_item_event',items['ITEM_PROTEIN'], 'any'),
		('bg_hidden_item_event',items['ITEM_RARE_CANDY'], 'any'),
		]

hidden_item_labels['Route106_MapBGEvents'] = [
		('bg_hidden_item_event',items['ITEM_POKE_BALL'], 'any'),
		('bg_hidden_item_event',items['ITEM_STARDUST'], 'any'),
		('bg_hidden_item_event',items['ITEM_HEART_SCALE'], 'any'),
		]

hidden_item_labels['VictoryRoad_B2F_MapBGEvents'] = [
		('bg_hidden_item_event',items['ITEM_ELIXIR'], 'any'),
		('bg_hidden_item_event',items['ITEM_MAX_REPEL'], 'any'),
		]

hidden_item_labels['Underwater_Route124_MapBGEvents'] = [
		('bg_hidden_item_event',items['ITEM_CARBOS'], 'any'),
		('bg_hidden_item_event',items['ITEM_GREEN_SHARD'], 'any'),
		('bg_hidden_item_event',items['ITEM_PEARL'], 'any'),
		('bg_hidden_item_event',items['ITEM_BIG_PEARL'], 'any'),
		('bg_hidden_item_event',items['ITEM_HEART_SCALE'], 'any'),
		('bg_hidden_item_event',items['ITEM_CALCIUM'], 'any'),
		('bg_hidden_item_event',items['ITEM_HEART_SCALE'], 'any'),
		]
...
hidden_item_labels['Route104_MapBGEvents'] = [
		...
		('ignore',None, 'any'),
		('ignore',None, 'any'),
		('bg_hidden_item_event',items['ITEM_SUPER_POTION'], 'any'),
		('bg_hidden_item_event',items['ITEM_POKE_BALL'], 'any'),
		('bg_hidden_item_event',items['ITEM_POTION'], 'any'),
		('bg_hidden_item_event',items['ITEM_ANTIDOTE'], 'any'),
		('bg_hidden_item_event',items['ITEM_HEART_SCALE'], 'any'),
		]

hidden_item_labels['GraniteCave_B2F_MapBGEvents'] = [
		('bg_hidden_item_event',items['ITEM_EVERSTONE'], 'any'),
		('bg_hidden_item_event',items['ITEM_EVERSTONE'], 'any'),
		]
...
hidden_item_labels['Route113_MapBGEvents'] = [
		...
		('ignore',None, 'any'),
		('bg_hidden_item_event',items['ITEM_ETHER'], 'any'),
		('bg_hidden_item_event',items['ITEM_TM32'], 'tm'),
		('bg_hidden_item_event',items['ITEM_NUGGET'], 'any'),
		]
...
hidden_item_labels['LilycoveCity_MapBGEvents'] = [
		...
		('ignore',None, 'any'),
		('bg_hidden_item_event',items['ITEM_HEART_SCALE'], 'any'),
		('bg_hidden_item_event',items['ITEM_PP_UP'], 'any'),
		('bg_hidden_item_event',items['ITEM_POKE_BALL'], 'any'),
		]

hidden_item_labels['JaggedPass_MapBGEvents'] = [
		('bg_hidden_item_event',items['ITEM_FULL_HEAL'], 'any'),
		('bg_hidden_item_event',items['ITEM_GREAT_BALL'], 'any'),
		]
...
hidden_item_labels['Route116_MapBGEvents'] = [
		...
		('ignore',None, 'any'),
		('bg_hidden_item_event',items['ITEM_SUPER_POTION'], 'any'),
		('bg_hidden_item_event',items['ITEM_BLACK_GLASSES'], 'any'),
		]
...
hidden_item_labels['Route121_MapBGEvents'] = [
		...
		('bg_hidden_item_event',items['ITEM_NUGGET'], 'any'),
		('bg_hidden_item_event',items['ITEM_FULL_HEAL'], 'any'),
		('bg_hidden_item_event',items['ITEM_MAX_REVIVE'], 'any'),
		]
...
hidden_item_labels['Route123_MapBGEvents'] = [
		...
		('ignore',None, 'any'),
		('ignore',None, 'any'),
		('bg_hidden_item_event',items['ITEM_SUPER_REPEL'], 'any'),
		('ignore',None, 'any'),
		('ignore',None, 'any'),
		('bg_hidden_item_event',items['ITEM_REVIVE'], 'any'),
		('bg_hidden_item_event',items['ITEM_HYPER_POTION'], 'any'),
		('bg_hidden_item_event',items['ITEM_PP_UP'], 'any'),
		('bg_hidden_item_event',items['ITEM_RARE_CANDY'], 'any'),
		]
...
hidden_item_labels['SafariZone_Southeast_MapBGEvents'] = [
		('bg_hidden_item_event',items['ITEM_PP_UP'], 'any'),
		('bg_hidden_item_event',items['ITEM_FULL_RESTORE'], 'any'),
		]
...
hidden_item_labels['PetalburgWoods_MapBGEvents'] = [
		('ignore',None, 'any'),
		('bg_hidden_item_event',items['ITEM_POTION'], 'any'),
		('bg_hidden_item_event',items['ITEM_TINY_MUSHROOM'], 'any'),
		('bg_hidden_item_event',items['ITEM_TINY_MUSHROOM'], 'any'),
		('bg_hidden_item_event',items['ITEM_POKE_BALL'], 'any'),
		]

hidden_item_labels['NavelRock_Top_MapBGEvents'] = [
		('bg_hidden_item_event',items['ITEM_SACRED_ASH'], 'any'),
		]

hidden_item_labels['MtPyre_Exterior_MapBGEvents'] = [
		('bg_hidden_item_event',items['ITEM_ULTRA_BALL'], 'any'),
		('bg_hidden_item_event',items['ITEM_MAX_ETHER'], 'any'),
		]
...
hidden_item_labels['SSTidalLowerDeck_MapBGEvents'] = [
		('bg_hidden_item_event',items['ITEM_LEFTOVERS'], 'any'),
		]
